      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <Input id="interviewer-filter" placeholder="Filter by interviewer code" value={interviewerCodeFilter} onChange={e => setInterviewerCodeFilter(e.target.value)} disabled={loading} />
          </div>
          ...
          <div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !dateFilter && "text-muted-foreground")} disabled={loading}>
